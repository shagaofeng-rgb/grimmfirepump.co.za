...
export type NewsSiteConfig = {
  siteId: string; enabled: boolean; brandName: string; siteUrl: string; industry: string; industryScope: string[];
  targetMarkets: string[]; publicationLanguage: string; locale: string; timezone: string;
...
export const newsSiteConfig: NewsSiteConfig = {
  siteId: "grimm-africa-za", enabled: true, brandName: "GRIMM PUMP Africa", siteUrl: "https://grimmfirepump.co.za",
  ...
  targetMarkets: ["South Africa","Africa"], publicationLanguage: "en", locale: "en-ZA", timezone: "Africa/Johannesburg",
  news: { listRoute: "/news", detailRoutePattern: "/news/[slug]", rssRoute: "/rss.xml", sitemapRoute: "/news-sitemap.xml", ingestIntervalHours: 24, publishIntervalHours: 24, candidateMaxAgeHours: 72, fallbackCandidateMaxAgeDays: 7, minScore: 70, maxInternalProductLinks: 1, defaultAuthorType: "Editorial Team" },
